...
let rec print_list_reaction lst =
	match lst with
	| [] -> print_endline "end"
	| hd::tl -> print_endline "rstart";print_tuple (hd#lol_get_start);print_endline "rend";print_tuple (hd#lol_get_result); print_list_reaction tl
...
let dec = new Decane.decane in
	...
	print_endline "________";
	print_endline "________";
	let r = new Alkane_combustion.alkane_combustion ([eth]) in

	let rstart = (ret1#lol_get_start) in
	let rend = (ret1#lol_get_result) in
	print_endline "___rstart_____";
	print_tuple rstart;
	print_endline "___rend_____";
	print_tuple rend;
	print_endline "_____inc___";
	let listofr = r#get_incomplete_results2 in
	print_list_reaction listofr;
	print_endline "________";
	print_endline "________"
